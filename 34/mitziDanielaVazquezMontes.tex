\lhead{\begin{tikzpicture}[remember picture, overlay]
    ...
    \title{\textbf{Proyecto Integrador tiempos predeterminados}} % Article title
    
     \author{ 
     \textsc{Vázquez-Montes,Mitzi Daniela}\\ 
    %  Afiliación:
     \texttt{Estudio del Trabajo II} \\ 
    ...
    \textbf{    \item Estudio de movimientos y tiempos:}
    ...
    \textbf{    \item Precisión:}
    Es la variación que se puede presentar en un fenómeno físico.
    
    \textbf{    \item Exactitud:}
    Es la cercanía que tiene una medición respecto a su objetivo.
    
    \textbf{    \item Muestreo:}
    Acción de escoger muestras representativas que describan de manera exacta las características de un conjunto de datos que nos dejen deducir, inferir y sacar conclusiones de un fenómeno a estudiar. \cite{RAE}
    
    \textbf{    \item Inferir:}
    Deducir algo o sacarlo de conclusión de otra cosa.\cite{RAE}
    
    \textbf{    \item Método de regreso a cero: }
    El cronómetro se lee a la terminación de cada elemento, y luego se regresa a cero de inmediato. Al iniciarse el siguiente elemento el cronómetro parte de cero.
    
    \textbf{    \item Método continuo:}
    Presenta un registro completo de todo el periodo de observación; como resultado, complace al operario y al sindicato.
    
        \textbf{\item Muestreo de trabajo:}
    Es una herramienta para disminuir el costo que se presenta en el estudio continuo de tiempo.
    
    \textbf{    \item MTM: (Medición de tiempos método)}
    ...
    \textbf{    \item STP: (Sistema de tiempos predeterminados)}
        Conjunto de reglas o métodos para determinar con anticipación la secuencia de sucesos. Determinar el tiempo necesario de hacer el trabajo. Están basados en los THERBLIGS.
    
    \textbf{    \item Therbligs: }
    Son los diecisiete movimientos en los que se puede subdividir cualquier tarea laboral para estudiar la productividad motriz de un operador en su estación de trabajo
    Los Gilbreth concluyeron que todo trabajo, ya sea productivo o no, se realiza mediante el uso de combinaciones de 17 movimientos básicos a los que ellos llamaron therblig.\cite{niebel1980ingenieria}  
       
    \end{enumerate}
    
    Es la exposición y descripción de un conjunto de datos de un fenómeno y se compone de verdades admitidas sin demostración que sirven como base para posteriores razonamientos lógicos y que permiten aproximar magnitudes mediante la secuencia de números, estimando la tendencia central y dispersión de parámetros.

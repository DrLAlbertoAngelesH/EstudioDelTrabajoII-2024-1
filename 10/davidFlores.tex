\lhead{\begin{tikzpicture}[remember picture, overlay]
    ...
    % define optimización
    \begin{itemize}
        \item\textbf{Estudio de tiempos:}Es una técnica de medición del trabajo que se utiliza para poder establecer y definir el ritmo al que puede trabajar cualquier persona en una tarea específica, tomando en cuenta las condiciones de esta misma tarea y el espacio en el que la llevara a cabo.
            \item\textbf{Estudio de movimientos:}Es eliminar o mejorar elementos innecesarios que podrían afectar la productividad, seguridad, y calidad de la producción. 
            \item\textbf{Ensamble:}Implica la colocación de dos o más piezas individuales para la conformación de un producto final. Suele dividirse en niveles dependiendo de la cantidad de componentes a unir, ya sean mecánicos, de software, electrónicos, farmacéuticos, o de cualquier otro tipo.
            ...
            \item\textbf{Método de tiempos predeterminados:}Los tiempos predeterminados, son una reunión de tiempos estándares válidos asignados a movimientos fundamentales y grupos de movimientos que no pueden ser evaluados de forma precisa con los procedimientos ordinarios para estudio de tiempos con cronómetro.
            \item\textbf{Optimización:}Hace referencia a la acción y efecto de optimizar. En términos generales, se refiere a la capacidad de hacer o resolver alguna cosa de la manera más eficiente posible y, en el mejor de los casos, utilizando la menor cantidad de recursos. 
             \item\textbf{Exacto:}Igual o que se asemeja en un grado muy alto a algo o alguien que es tomado como modelo. 
            \item\textbf{Preciso:}Dicho de una cosa: Perceptible de manera clara y nítida.
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[trim = {40mm 120mm 50mm 100mm},clip,scale=0.2]{10/Arduino.pdf}
        \caption{Arduino}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[trim = {30mm 30mm 30mm 30mm},clip,scale=0.05]{10/Cable usb.pdf}
        \caption{Cable usb}
        \label{fig:enter-label}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[trim = {30mm 30mm 30mm 30mm},clip,scale=0.2]{10/Cables dupont.pdf}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[trim = {30mm 30mm 30mm 30mm},clip,scale=0.2]{10/Display.pdf}
        \caption{Display}
        \label{fig:enter-label}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[trim = {30mm 30mm 30mm 30mm},clip,scale=0.2]{10/Modulo adaptador.pdf}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[trim = {30mm 30mm 30mm 30mm},clip,scale=0.05]{10/Multicontacto.pdf}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[trim = {30mm 30mm 30mm 30mm},clip,scale=0.2]{10/Potenciometro.pdf}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[trim = {30mm 30mm 30mm 30mm},clip,scale=0.2]{10/Protoboard.PDF}
        \caption{Protoboard}
        \label{fig:enter-label}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[trim = {30mm 30mm 30mm 30mm},clip,scale=0.2]{10/Resistencias.pdf}

\lhead{\begin{tikzpicture}[remember picture, overlay]
    ...
    \end{figure}
        ...
        Después de entender los pasos y el proceso que se llevará acaba para realizar el ensamble se pedirá al operario que lea con atención todos los pasos presentes en el manual para que que lleve acabo el ensamble del circuito, observando tanto la cantidad de piezas a ocupar de cada material como la forma en la que se realizarán las uniones de estas.
         \newpage
    ...
    \end{figure}
         ...
         Después el operador dará inicio al proceso, con el inicio del operario el analista esta preparado con una tabla para anotar los tiempos de cada paso y un cronometro para medir el tiempo que tardará.

\lhead{\begin{tikzpicture}[remember picture, overlay]
  ...
  \newpage
    ...
    \end{figure}
         ...
         Posterior a ello el operador dará inicio al proceso, con el inicio del operario el analista esta preparado con una tabla para anotar los tiempos de cada paso y un cronometro para medir el tiempo que tardará.

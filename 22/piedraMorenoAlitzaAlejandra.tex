...
\hline
 PC-02  & Protoboard & \begin{center}
     \includegraphics[width=.2\textwidth]{22/img/protoboardFigura.pdf}~\\[5cm]  \end{center} & \\
\hline
...
\hline
PC-09 & Cable MM  & \begin{center} \includegraphics[width=.2\textwidth]{22/img/cableMHFigura.pdf}~\\[5cm] \end{center}  &  \\
\hline
 PC-10  & Multicontacto  &   & \\
\hline
...
\subsubsection{PC-01: Almohadilla de silicona para soldar}
...
\begin{center}
\includegraphics[width=.85\textwidth]{22/img/móduloI2CInterfazDibujo.pdf}~\\[15cm]
\end{center}

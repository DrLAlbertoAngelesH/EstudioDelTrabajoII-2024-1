\lhead{\begin{tikzpicture}[remember picture, overlay]
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.20]{1/img/Protoboard.pdf}
        \caption{Protoboard.}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.20]{1/img/Cable tipo C.pdf}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.20]{1/img/Multicontacto.pdf}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.20]{1/img/Conector.pdf}
        \caption{Modulo spei}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.20]{1/img/Resistencia.pdf}
        \caption{Resistencia.}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.20]{1/img/cable conetor.pdf}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.20]{1/img/Potenciometro.pdf}

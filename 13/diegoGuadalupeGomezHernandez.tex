\lhead{\begin{tikzpicture}[remember picture, overlay]
    ...
    \begin{itemize}
        \item Para lograr el ensamble y poder tomar tiempos debemos de seguir el siguiente manual.

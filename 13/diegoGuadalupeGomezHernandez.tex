\lhead{\begin{tikzpicture}[remember picture, overlay]
    ...
    Para poder llegar a tener un tiempo estándar y un tiempo ciclo necesitamos de distintas tablas y formulas las cuales usaremos posteriormente. 
    
    Holgura total = {Fecha de finalización más tardía} - {Fecha de finalización más temprana} 

\lhead{\begin{tikzpicture}[remember picture, overlay]
    ...
    \item El estudio de tiempos y movimientos es el análisis de métodos, materiales, herramientas e instalaciones. 
    \item Por ensamble se entiende que es la colocación de dos o más piezas para la conformación de un producto final. Hay diferentes  metodologías de ensamblaje como la línea de ensamblaje tradicional o el ensamblaje celular. También están las técnicas de ensamblaje automatizado.
    \item Un circuito electrónico es el conjunto de elementos eléctricos conectados entre sí que permiten generar, transportar y utilizar la energía eléctrica. Hoy en día los avances tecnológicos en electrónica son resultado de la miniaturización de los elementos físicos dentro de un circuito integrado, encapsulando los elementos electrónicos lo más pequeños posible, esto con el fin reducir el peso, energía de consumo, el calor y que a su vez sean menos costosos y pesados.
    \item El método de tiempos predeterminados es la manera de determinar con anticipación de forma organizada la secuencia de sucesos. De esta manera podríamos hacer un análisis de métodos para determinar un método eficiente de trabajo y determinar el tiempo necesario para hacer el trabajo. 
    % \begin{itemize}

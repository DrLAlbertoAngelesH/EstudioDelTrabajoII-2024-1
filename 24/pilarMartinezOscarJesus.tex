\lhead{\begin{tikzpicture}[remember picture, overlay]
    ...
    % 
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \centering{\section[\appendixautorefname{}]{Apéndice}}\label{anexo:ensambleCircuitoElectronico}
    \includepdf[pages=-]{24/Img/ensambleCircuitoElectronico.pdf}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \centering{\section[\appendixautorefname{}]{Apéndice}}\label{anexo:circuitoElectricoinstructivo}
    \includepdf[pages=-]{24/Img/circuitoElectricoinstructivo.pdf}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \centering{\section[\appendixautorefname{}]{Apéndice}}\label{anexo:circuitoElectricoinstructivo2}
    \includepdf[pages=-]{24/Img/circuitoElectricoinstructivo2.pdf}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \centering{\section[\appendixautorefname{}]{Apéndice}}\label{anexo:procesodeCircuito}
    \includepdf[pages=-]{24/Img/procesodeCircuito.pdf}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%